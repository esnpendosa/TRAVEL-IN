...
$query = "SELECT t.id, t.nama_layanan, t.jenis, t.kapasitas, t.rute, t.lokasi, t.harga, t.kontak, t.gambar, t.status, t.deskripsi, u.nama_lengkap AS mitra
          FROM transportasi t
...
<head>
    ...
    <title>Validasi Transportasi - Rencana-IN</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="table-container">
            <table id="tabel-transportasi" class="styled-table">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Gambar</th>
                ...
                <tbody>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            <td><?= $no++ ?></td>
                            <td>
                                <img src="../asset/transportasi/<?= htmlspecialchars($row["gambar"]); ?>" alt="Gambar Transportasi" width="75">
                            </td>
                            ...
                            <td style="white-space: nowrap;">
                                <a href="validasi_transportasi.php?id=<?= $row['id'] ?>&action=approve" class="btn btn-success btn-approve">Approve</a>
                                <a href="validasi_transportasi.php?id=<?= $row['id'] ?>&action=reject" class="btn btn-danger btn-reject">Reject</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
        ...
        document.querySelectorAll('.btn-approve').forEach(button => {
            button.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    text: 'Apakah Anda yakin ingin menyetujui transportasi ini?',
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
        ...
        document.querySelectorAll('.btn-reject').forEach(button => {
            button.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    text: 'Apakah Anda yakin ingin menolak transportasi ini?',
                    icon: 'error',
                    showCancelButton: true,
