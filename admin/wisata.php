...
$query = "SELECT w.id, w.nama_wisata, w.kategori, w.lokasi, w.harga_tiket, w.jam_operasional, w.deskripsi, w.gambar, w.status, u.nama_lengkap AS mitra
          FROM wisata w
          JOIN user u ON w.created_by = u.id
...
<head>
    ...
    <title>Validasi Wisata - Rencana-IN</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="table-container">
            <table id="tabel-wisata" class="styled-table">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Gambar</th>
                ...
                <tbody>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            <td><?= $no++ ?></td>
                            <td>
                                <img src="../asset/wisata/<?= htmlspecialchars($row["gambar"]); ?>" alt="Gambar Wisata" width="75">
                            </td>
                            ...
                            <td style="white-space: nowrap;">
                                <a href="validasi_wisata.php?id=<?= $row['id'] ?>&action=approve" class="btn btn-success btn-approve">Approve</a>
                                <a href="validasi_wisata.php?id=<?= $row['id'] ?>&action=reject" class="btn btn-danger btn-reject">Reject</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
        ...
        document.querySelectorAll('.btn-approve').forEach(button => {
            button.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    text: 'Apakah Anda yakin ingin menyetujui wisata ini?',
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
        ...
        document.querySelectorAll('.btn-reject').forEach(button => {
            button.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    text: 'Apakah Anda yakin ingin menolak wisata ini?',
                    icon: 'error',
                    showCancelButton: true,
